...
CONSUMER_KEY = getattr(settings, 'CONSUMER_KEY', 'vZXdt9cK5LqoJ4HTM2leDg')
CONSUMER_SECRET = getattr(settings, 'CONSUMER_SECRET', '8jfjd40VK6qc4OdyFGhwcyq1ekqz5xStzdhMPnpmxk')
